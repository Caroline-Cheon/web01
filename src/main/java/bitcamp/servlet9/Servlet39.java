 ...
 *    웹 서버는 웹 브라우저에게 쿠키로 세션 아이디를 내려 보낸다.

 * => 이미 HttpSession 객체가 존재할 때는 새로 객체를 만들지 않기 때문에
 *    웹 브라우저로 세션 아이디를 보내지 않는다.
...
Set-Cookie: JSESSIONID=B98F14856A3885D3E5349F7DFC9D823A; Path=/web01; HttpOnly
Content-Type: text/plain;charset=UTF-8
Content-Length: 80
Date: Fri, 23 Dec 2016 06:53:51 GMT
-----------------------------------------------------------------------------------------
 */
...
Accept-Encoding: gzip, deflate, sdch, br
Accept-Language: ko-KR,ko;q=0.8,en-US;q=0.6,en;q=0.4
Cookie: JSESSIONID=B98F14856A3885D3E5349F7DFC9D823A
-----------------------------------------------------------------------------------------
 *
...
Content-Type: text/plain;charset=UTF-8
Content-Length: 80
Date: Fri, 23 Dec 2016 06:55:47 GMT
-----------------------------------------------------------------------------------------
 */
