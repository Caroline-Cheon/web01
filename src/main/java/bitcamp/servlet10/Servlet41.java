...
Content-Length: 284938
Cache-Control: max-age=0
Origin: http://localhost:8080
Upgrade-Insecure-Requests: 1
User-Agent: Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36
Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryXFiH4uBBBM06mSpC
Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*...
Referer: http://localhost:8080/web01/servlet/servlet41_form.html
Accept-Encoding: gzip, deflate, br
Accept-Language: ko-KR,ko;q=0.8,en-US;q=0.6,en;q=0.4

------WebKitFormBoundaryXFiH4uBBBM06mSpC
...
ccc
------WebKitFormBoundaryXFiH4uBBBM06mSpC
Content-Disposition: form-data; name="photo"; filename="FireShot Capture 46 - 대시보드 - Google 검색_ - https___www.google.co.kr_search.png"
    ...
    try {
      ...
      for (FileItem item : items) {
        if (item.isFormField()) { // 일반 폼 항목이면,
          ...
          /*
          item.write(new File("C:/Users/BitCamp/git/web01/src/main/webapp/upload/" 
          + item.getName()));
          */
          ...
          item.write(new File(
              // ServletContext는 "/upload/파일명"의 실제 배치 경로를 알아내 준다.
              sc.getRealPath("/upload/" + item.getName())));
        }
      }
